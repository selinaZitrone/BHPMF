...
class HPMF {
 ...
 public:
  ~HPMF();
  /*    HPMF(const char* input_dir, const int num_columns, int
     num_latent_features, int num_hierarchy_level, int used_hierarchy_level, int
     predict_level, int fold_id, int saveFileFlag, int outWholeFlag, int gaps,
     int burn, int num_samples, const char* mean_file_path, const char*
     std_file_path, double* num_nodes_per_level);
   */
  HPMF(const int num_columns, int num_latent_features,
       double* num_nodes_per_level, int predict_level, int num_hierarchy_level,
       int used_hierarchy_level, int gaps, int burn, int num_samples,
       int fold_id, const char* input_dir, int saveFileFlag, int outWholeFlag,
       const char* mean_file_path, const char* std_file_path, int verbose);
